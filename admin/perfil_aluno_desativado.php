        ...
        <div class="main-content">
            <div class="dashboard-header">
                ...
                <div class="admin-actions">
                    ...
                    <a href="alunos_inativos.php?remover=<?php echo $id_aluno; ?>" class="action-btn delete-btn" onclick="return confirm('Tem certeza que deseja reactivar este aluno?')">Reactivar aluno</a>
                </div>
            </div>
