...
if (!isset($_SESSION['admin_logado']) || $_SESSION['admin_nivel'] != 'super') {
    echo "<script>
        alert('Você não tem AUTORIZAÇÃO ou NÍVEL para acessar esta página!');
        window.location.href = 'painel_admin_comum.php';
    </script>";
    exit();
}
...
// esse mambo faz o processo do novo admin
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <div class="user-profile">
                ...
                <p class="user-email">Super Admin</p>
            </div>
     ...
     <!-- Aquela banda onde vai aparecer na tela para add on novo adm -->
...
<style>
    /* Estilos para a section de adicionar novo admin */
    .modal {
        display: none;
        position: fixed;
        top: 0;
...
<script>
    // Função para mostrar a section de novo admi
